...
using SharpVision.Terminal.Posix;
using SharpVision.Terminal.Windows;
...
public class TVDemo : TApplication
{
    ...
    private void OpenTerminalDemo()
    {
        ...
        memSession.Emit("SharpVision TTerminal \u2014 interactive demo\n");
        memSession.Emit("------------------------------------------\n");
    ...
    private static void RunSelectionDemo(TTerminal term)
    {
        ...
        term.WriteLine("Row C: SharpVision TTerminal selection test line");
