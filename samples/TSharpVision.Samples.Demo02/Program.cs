...
//
// Force a specific driver: set TSHARPVISION_DRIVER=Win32ConsoleDriver
// Headless fallback:       set TSHARPVISION_DRIVER=NullDriver
using TSharpVision;
...
public class TVDemoApp : TApplication
{
    ...
    private void OpenWelcomeWindow()
    {
        ...
        win.Insert(new TStaticText(
            ...
            "TSharpVision is a C#/.NET 8 reimplementation\n" +
