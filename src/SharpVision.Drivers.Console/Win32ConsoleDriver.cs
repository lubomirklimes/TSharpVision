...
namespace SharpVision.Drivers.Console;
...
public sealed class Win32ConsoleDriver : IDriver, IDisposable
{
    ...
    public void Shutdown()
    {
        ...
        // returns to a tidy state after the SharpVision UI exits.
            ...
            switch (r.EventType)
            {
                ...
                case WINDOW_BUFFER_SIZE_EVENT:
                {
                    ...
                    // and force a full redraw on the next HandleEvent cycle.
                    {
                        ...
                        resEv.What = SharpVision.Constants.Events.evCommand;
                        resEv.message.command = SharpVision.Constants.Views.cmScreenResized;
