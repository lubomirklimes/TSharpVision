...
public class TDeskTop : TGroup
{
    ...
    // CP437 0xB0 = light shade '░'. See SharpVisionGlyphs.BackgroundFillLight.
    public static char defaultBkgrnd  = SharpVisionGlyphs.BackgroundFillLight;
    public static char odefaultBkgrnd = SharpVisionGlyphs.BackgroundFillLight;
