...
public class TColorDialog : TDialog
{
    ...
    public TColorDialog(TPalette aPalette, TColorGroup aGroups)
        : base(new TRect(0, 0, 77, 18), SharpVisionIntl.Get("Color_Title", "Colors"))
    {
        ...
        Insert(_groups);
        Insert(new TLabel(new TRect(2, 2, 11, 3), SharpVisionIntl.Get("Color_Lbl_Group", "~G~roup"), _groups));
        ...
        var itemList = new TColorItemList(
            ...
            sbItemsH);
        Insert(itemList);
        Insert(new TLabel(new TRect(33, 2, 39, 3), SharpVisionIntl.Get("Color_Lbl_Item", "~I~tem"), itemList));
        ...
        Insert(_forSel);
        _forLabel = new TLabel(new TRect(61, 2, 73, 3), SharpVisionIntl.Get("Color_Lbl_Foreground", "~F~oreground"), _forSel);
        Insert(_forLabel);
        ...
        Insert(_bakSel);
        _bakLabel = new TLabel(new TRect(61, 8, 73, 9), SharpVisionIntl.Get("Color_Lbl_Background", "~B~ackground"), _bakSel);
        Insert(_bakLabel);
        ...
        Insert(new TButton(new TRect(31, 15, 44, 17),
            SharpVisionIntl.Get("Color_Btn_Try", "~T~ry"), Views.cmTryColors, ButtonConstants.bfNormal));
        Insert(new TButton(new TRect(46, 15, 59, 17),
            SharpVisionIntl.Get("Btn_OK", "~O~K"), Views.cmOK, ButtonConstants.bfDefault));
        Insert(new TButton(new TRect(61, 15, 74, 17),
            SharpVisionIntl.Get("Btn_Cancel", "Cancel"), Views.cmCancel, ButtonConstants.bfNormal));
