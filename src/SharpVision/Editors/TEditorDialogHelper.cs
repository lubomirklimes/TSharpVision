...
public static class TEditorDialogHelper
{
    ...
    private static ushort DefaultOverwriteConfirm(TDeskTop deskTop, string path)
    {
        ...
        return MsgBox.MessageBox(deskTop,
            string.Format(
                SharpVisionIntl.Get("File_ConfirmOverwrite",
            ...
            switch (dialog)
            {
                case Views.edSaveAs:
                {
                    ...
                    var dlg = new TFileDialog("*.*",
                        SharpVisionIntl.Get("File_Title_SaveAs", "Save File As"),
                ...
                case Views.edSaveModify:
                {
                    ...
                    return MsgBox.MessageBox(deskTop,
                        string.Format(
                            SharpVisionIntl.Get("Edit_SaveModify", "{0} has been modified. Save?"),
                ...
                case Views.edSaveUntitled:
                    if (deskTop == null) return Views.cmCancel;
                    return MsgBox.MessageBox(deskTop,
                        SharpVisionIntl.Get("Edit_SaveUntitled", "Save untitled file?"),
                        MsgBox.mfInformation | MsgBox.mfYesNoCancel);
                ...
                case Views.edCreateError:
                    ...
                    MsgBox.MessageBox(deskTop,
                        string.Format(
                            SharpVisionIntl.Get("Edit_Err_Create", "Error creating file '{0}'."),
                            info as string),
                ...
                case Views.edReadError:
                    ...
                    MsgBox.MessageBox(deskTop,
                        string.Format(
                            SharpVisionIntl.Get("Edit_Err_Read", "Error reading file '{0}'."),
                            info as string),
                        MsgBox.mfError | MsgBox.mfOKButton);
                    return Views.cmOK;
                ...
                case Views.edWriteError:
                    ...
                    MsgBox.MessageBox(deskTop,
                        string.Format(
                            SharpVisionIntl.Get("Edit_Err_Write", "Error writing file '{0}'."),
                            info as string),
                        MsgBox.mfError | MsgBox.mfOKButton);
                    return Views.cmOK;
                ...
                case Views.edOutOfMemory:
                    if (deskTop == null) return Views.cmOK;
                    MsgBox.MessageBox(deskTop,
                        SharpVisionIntl.Get("Edit_Err_OOM", "Not enough memory for editor buffer."),
                        MsgBox.mfError | MsgBox.mfOKButton);
                    return Views.cmOK;
                ...
                case Views.edSearchFailed:
                    if (deskTop == null) return Views.cmOK;
                    MsgBox.MessageBox(deskTop,
                        SharpVisionIntl.Get("Edit_SearchFailed", "Search string not found."),
                        MsgBox.mfError | MsgBox.mfOKButton);
                    return Views.cmOK;
                ...
                case Views.edReplacePrompt:
                {
                    ...
                    return MsgBox.MessageBoxRect(deskTop, r,
                        SharpVisionIntl.Get("Edit_ReplacePrompt", "Replace this occurrence?"),
