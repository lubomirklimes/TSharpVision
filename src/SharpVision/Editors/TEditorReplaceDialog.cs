...
public static class TEditorReplaceDialog
{
                                ...
                                out TCheckBoxes checkBoxes)
    {
        var dlg = new TDialog(new TRect(0, 0, 40, 16),
            SharpVisionIntl.Get("Edit_ReplaceTitle", "Replace"));
        ...
        dlg.Insert(new TLabel(new TRect(2, 2, 34, 3),
            SharpVisionIntl.Get("Edit_FindText", "~T~ext to find"), findInput));
        ...
        dlg.Insert(new TLabel(new TRect(2, 5, 34, 6),
            SharpVisionIntl.Get("Edit_ReplaceText", "~R~eplace with"), replaceInput));
        ...
        checkBoxes = new TCheckBoxes(new TRect(3, 8, 37, 12),
            new TSItem(SharpVisionIntl.Get("Edit_Chk_CaseSensitive",   "~C~ase sensitive"),
            new TSItem(SharpVisionIntl.Get("Edit_Chk_WholeWords",      "~W~hole words only"),
            new TSItem(SharpVisionIntl.Get("Edit_Chk_PromptOnReplace", "~P~rompt on replace"),
            new TSItem(SharpVisionIntl.Get("Edit_Chk_ReplaceAll",      "Replace ~A~ll"), null)))));
