...
public class TIndicator : TView
{
    ...
    // See SharpVisionGlyphs for the canonical names and CP437 byte values.
    public static char DragFrame    = SharpVisionGlyphs.IndicatorDragFrame;   // '═' U+2550, was '\xCD' (CP437)
    public static char NormalFrame  = SharpVisionGlyphs.IndicatorNormalFrame; // '─' U+2500, was '\xC4' (CP437)
    public static char ModifiedStar = SharpVisionGlyphs.IndicatorModified;    // '●' U+25CF, replaces (char)15
