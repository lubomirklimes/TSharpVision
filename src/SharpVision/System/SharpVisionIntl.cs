...
//
// Usage:
//   SharpVisionIntl.Get("Btn_OK", "~O~K")          // explicit key + fallback
//   SharpVisionIntl._("~O~K")                       // literal used as both key and fallback
//   SharpVisionIntl._("~O~K", "Btn_OK")             // literal fallback, custom key
//
...
/// <summary>
/// Contract for a SharpVision string provider.
/// </summary>
public interface ISharpVisionStringProvider
{
    /// <summary>
...
/// that match every hard-coded string in the SharpVision library.
/// Unknown keys fall back to the caller-supplied literal.
/// </summary>
public sealed class DefaultEnglishStringProvider : ISharpVisionStringProvider
{
...
/// </para>
/// </summary>
public static class SharpVisionIntl
{
    /// <summary>
    /// The active string provider. Replace to inject a locale or test stub.
    /// </summary>
    public static ISharpVisionStringProvider Current { get; set; }
