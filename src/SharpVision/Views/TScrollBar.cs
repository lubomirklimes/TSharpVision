...
public class TScrollBar : TView
{
    ...
    // matching Unicode box-drawing glyphs. See SharpVisionGlyphs for the canonical names.
    ...
    {
        SharpVisionGlyphs.ScrollArrowUp,   // ▲  CP437 0x1E — top endpoint
        SharpVisionGlyphs.ScrollArrowDown, // ▼  CP437 0x1F — bottom endpoint
        SharpVisionGlyphs.ScrollBarTrack,  // ▒  CP437 0xB1 — empty track
        SharpVisionGlyphs.ScrollBarThumb,  // ■  CP437 0xFE — thumb mark
        SharpVisionGlyphs.ScrollBarBright, // ░  CP437 0xB0 — full/bright fill
    };
    protected static readonly char[] hChars = new char[5]
    {
        SharpVisionGlyphs.ScrollArrowLeft,  // ◄  CP437 0x11 — left endpoint
        SharpVisionGlyphs.ScrollArrowRight, // ►  CP437 0x10 — right endpoint
        SharpVisionGlyphs.ScrollBarTrack,   // ▒  CP437 0xB1 — empty track
        SharpVisionGlyphs.ScrollBarThumb,   // ■  CP437 0xFE — thumb mark
        SharpVisionGlyphs.ScrollBarBright,  // ░  CP437 0xB0 — full/bright fill
    };
