...
// SdlPalette.DecodeAttr is pure; SDLDriver runs under SHARPVISION_NO_SDL=1.
using System.IO;
using SharpVision;
...
public sealed class SdlPaletteTests
{
    ...
    {
        Environment.SetEnvironmentVariable("SHARPVISION_NO_SDL", "1");
        try
        {
        ...
        {
            Environment.SetEnvironmentVariable("SHARPVISION_NO_SDL", null);
        }
    }
