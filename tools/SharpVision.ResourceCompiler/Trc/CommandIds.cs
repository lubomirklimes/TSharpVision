...
{
    // Fixed built-in map referencing SharpVision.Constants.Views directly.
    ...
    // Maps the friendly key strings used in .trc files to SharpVision key codes.
    ...
    /// SharpVision key code (<see cref="Keys"/>).
